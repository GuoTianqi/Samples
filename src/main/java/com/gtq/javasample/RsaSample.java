...
public class RsaSample {
    ...
    public static void testRsa() {
        try {
            PrivateKey privateKey = getPrivateKey("QySecurityCodeKeyStore.jks",
                    "qysecuritycode","xM!@#(*&", "xM!@#(*&");
     ...
     * @throws Exception
     */
    public static String encryptByPrivateKey(PrivateKey privateKey, String srcData) throws Exception{
        // 对数据加密
        Cipher cipher = Cipher.getInstance("RSA");
        ...
        File file = new File("QyAuthFileRelease");
     ...
     * @throws Exception
     */
    public static String descryptByPublicKey(PublicKey publicKey, String data) throws Exception{
        // BASE64转码解密密文
        byte[] text = decryptBASE64(data);
        // 对数据解密
        Cipher cipher = Cipher.getInstance("RSA");
